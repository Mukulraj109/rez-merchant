# Rez Merchant - iOS & Android Deployment Guide
...
# Configure EAS for the project (run from rez-merchant directory)
cd rez-merchant
...
6. Save as `google-service-account.json` in the `rez-merchant` folder
...
| Web Hosting (Vercel/Netlify) | $0 | Free tier |
