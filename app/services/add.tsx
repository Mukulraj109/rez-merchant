...
const pk = StyleSheet.create({
  ...
  searchWrap: { flexDirection: 'row', alignItems: 'center', marginHorizontal: 20, paddingHorizontal: 14, paddingVertical: 10, backgroundColor: '#F3F4F6', borderRadius: 10, gap: 8, marginBottom: 8 },
  ...
  itemLabel: { fontSize: 15, color: '#374151', fontWeight: '500' },
...
const st = StyleSheet.create({
  ...
  secTitle: { fontSize: 18, fontWeight: '700', color: '#1F2937', marginBottom: 16 },
  ...
  selectBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14 },
  selectText: { fontSize: 16, color: '#1F2937', flex: 1 },
  row: { flexDirection: 'row' },
  chipRow: { flexDirection: 'row', gap: 10 },
  chip: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: '#E5E7EB', backgroundColor: '#F9FAFB', gap: 6 },
  ...
  imgAdd: { width: 100, height: 100, borderRadius: 12, borderWidth: 2, borderColor: '#E5E7EB', borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center' },
